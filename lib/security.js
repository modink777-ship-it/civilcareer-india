...
function allowSameOrigin(req, res, options = {}) {
  const publicRead = options.publicGet && ['GET','HEAD','OPTIONS'].includes(String(req.method || '').toUpperCase());
  if (!publicRead && !sameOrigin(req)) {
